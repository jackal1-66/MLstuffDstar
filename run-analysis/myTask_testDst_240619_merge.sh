...
export ARG="myTask_testDst_240619_merge.C(\"$1\",$2)"
root -b -q -x $ARG
RET=$?
if [ "$RET" != "0" ];then
  echo "======== ERROR : myAnalysis.C finished with NON zero code: $RET ========"
...
echo "======== myTask_testDst_240619_merge.C finished with exit code: $? ========"
echo "############## memory after: ##############"
free -m
